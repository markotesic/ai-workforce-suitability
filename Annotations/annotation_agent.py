...
def annotation_agent(
    ...
    **kwargs: Unpack[BasicAgentDeprecatedArgs],
    ...
    This is a copy of the basic agent but with a tweak to make the submission tool
    take int rather than a string. this makes extracting a score easier.
    ...
    @tool
    def submit() -> Tool:
        async def execute(answer: int) -> ToolResult:
            """Submit an answer for evaluation.

            Args:
              answer (int): The score for the task.
            """
            return answer
